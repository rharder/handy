...
class NetMemApp():
    def __init__(self, root, local_addr, remote_addr, is_multicast):
        self.window = root
        ...
        self.netmem.connect_on_new_thread(local_addr=local_addr,
                                          local_is_multicast=is_multicast,
...
def main():
    ...
    #                      local_addr=("225.0.0.1", 9991), is_multicast=True,
    #                      remote_addr=("225.0.0.2", 9992))
    program2 = NetMemApp(tk2,
                         local_addr=("225.0.0.2", 9992), is_multicast=True,
